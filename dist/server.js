...
import { searchToolSchema, executeSearch, principlesToolSchema, executePrinciples, patternsToolSchema, executePatterns, tokensToolSchema, executeTokens, accessibilityToolSchema, executeAccessibility, } from './tools/index.js';
/**
            ...
            tools: [
                {
                    ...
                    description: 'Search across all UI/UX design knowledge including principles, patterns, and tokens using fuzzy matching. Returns relevant results with relevance scores.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            query: {
                ...
                },
                {
                    ...
                    description: `Retrieve UI/UX design principles including Nielsen\'s heuristics, Gestalt principles, Laws of UX, accessibility guidelines, and more. Contains ${knowledgeStats.principleCount} principles across ${knowledgeStats.categoryCount} categories.`,
                    inputSchema: {
                        type: 'object',
                        properties: {
                            id: {
                ...
                },
                {
                    ...
                    description: `Retrieve UI/UX design patterns for common interface problems. Contains ${knowledgeStats.patternCount} patterns covering navigation, forms, feedback, and layout. Each pattern includes problem, solution, structure, consequences, and accessibility considerations.`,
                    inputSchema: {
                        type: 'object',
                        properties: {
                            id: {
                ...
                },
                {
                    ...
                    description: `Retrieve design tokens for colors, spacing, typography, shadows, and more. Contains ${knowledgeStats.tokenCount} tokens providing a complete design token system.`,
                    inputSchema: {
                        type: 'object',
                        properties: {
                            name: {
                ...
                },
                {
                    ...
                    description: 'Get a WCAG-based accessibility checklist for specific component types. Returns critical and additional requirements at the specified conformance level.',
                    inputSchema: {
                        type: 'object',
                        properties: {
                            component: {
