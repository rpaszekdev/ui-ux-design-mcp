...
export const gestaltPrinciples = [
    {
        ...
        subcategory: 'gestalt',
        summary: 'Objects that are near each other are perceived as a group. Use spacing to create visual relationships.',
        description: 'Elements placed close together are perceived as related, while elements farther apart are seen as separate. This principle is fundamental to visual organization and allows designers to create groupings without borders or backgrounds. The spacing between elements communicates relationships.',
        rationale: 'Proximity is one of the strongest visual grouping cues. Proper use of proximity can replace the need for explicit containers, creating cleaner designs while maintaining clear organization.',
        examples: {
            good: [
    ...
    },
    {
        ...
        category: DesignCategory.USER_INTERFACE,
        subcategory: 'gestalt',
        summary: 'Elements that share visual characteristics (color, shape, size) are perceived as related or grouped.',
        description: 'When elements look alike, users perceive them as part of the same group or having the same function. Similarity can be created through color, shape, size, texture, or orientation. Breaking similarity draws attention to different elements.',
        rationale: 'Similarity helps users quickly understand what elements do without reading labels. Consistent styling of similar functions reduces cognitive load. Strategic breaks in similarity create emphasis.',
        examples: {
            good: [
    ...
    },
    {
        ...
        category: DesignCategory.USER_INTERFACE,
        subcategory: 'gestalt',
        summary: 'Elements arranged on a line or curve are perceived as more related than elements not on the line or curve.',
        description: 'The eye naturally follows lines and curves. Elements aligned on a path are perceived as related. This principle guides the eye through a design and creates visual flow. Breaking continuity creates stopping points.',
        rationale: 'Alignment creates order and guides attention. Well-aligned elements feel organized and professional. Poor alignment creates visual noise and makes interfaces harder to scan.',
        examples: {
            good: [
    ...
    },
    {
        ...
        category: DesignCategory.USER_INTERFACE,
        subcategory: 'gestalt',
        summary: 'The mind tends to complete incomplete shapes. Users perceive whole objects even when parts are missing.',
        description: 'When presented with incomplete visual information, the human brain fills in the gaps to perceive a complete object. This allows designers to suggest shapes without drawing them completely, creating elegant and minimal designs.',
        rationale: 'Closure enables minimalist design. Well-designed logos and icons leverage closure to convey meaning with less visual noise. It also explains why users understand implied boundaries.',
        examples: {
            good: [
    ...
    },
    {
        ...
        category: DesignCategory.USER_INTERFACE,
        subcategory: 'gestalt',
        summary: 'People instinctively separate elements into foreground (figure) and background (ground). Design should make this distinction clear.',
        description: 'The eye naturally differentiates between the main subject (figure) and its surrounding area (ground). In UI design, this determines what users perceive as interactive content versus backdrop. Modal overlays, cards, and focus states all leverage figure-ground.',
        rationale: 'Clear figure-ground relationships help users understand what\'s important and interactive. Ambiguous relationships cause confusion. Layering creates visual depth and hierarchy.',
        examples: {
            good: [
    ...
    },
    {
        ...
        category: DesignCategory.USER_INTERFACE,
        subcategory: 'gestalt',
        summary: 'Elements within a bounded area are perceived as grouped. Borders and backgrounds create visual containers.',
        description: 'When elements share a clearly defined boundary—whether through borders, backgrounds, or other visual containers—they are perceived as belonging together. This is foundational to card-based design and section organization.',
        rationale: 'Common region is a strong grouping cue that works even when proximity would suggest otherwise. It allows flexible layouts while maintaining clear organization.',
        examples: {
            good: [
    ...
    },
    {
        ...
        category: DesignCategory.USER_INTERFACE,
        subcategory: 'gestalt',
        summary: 'Elements that move in the same direction are perceived as more related than elements moving differently or stationary.',
        description: 'Motion creates grouping. Elements that animate together are seen as related. This principle is crucial for interface animations and transitions. It also applies to elements that change state together (like form fields in validation).',
        rationale: 'Motion is a powerful attention director. Coordinated animations create cohesive experiences. Conflicting motions create visual confusion.',
        examples: {
            good: [
    ...
    },
    {
        ...
        category: DesignCategory.USER_INTERFACE,
        subcategory: 'gestalt',
        summary: 'Elements that stand out visually capture attention first. Create clear focal points to guide user attention.',
        description: 'Whatever stands out visually will attract attention first. Focal points can be created through size, color, contrast, shape, or position. Every screen should have a clear primary focal point that guides users to the most important element.',
        rationale: 'Without clear focal points, users\' attention wanders aimlessly. Strategic focal points guide users through the interface in the intended order and ensure important elements aren\'t missed.',
        examples: {
            good: [
