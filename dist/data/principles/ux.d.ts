 ...
 */
export declare const nielsenHeuristics: DesignPrinciple[];
/**
 * Laws of UX - psychological principles applied to design
 * Based on publicly documented cognitive psychology principles
 */
export declare const lawsOfUx: DesignPrinciple[];
/**
 * Additional core UX principles
 */
export declare const coreUxPrinciples: DesignPrinciple[];
export declare const uxPrinciples: DesignPrinciple[];
