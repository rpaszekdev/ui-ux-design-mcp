...
export const formPatterns = [
    {
        ...
        solution: 'Validate input fields as users type or move to the next field. Show success indicators for valid input and error messages near invalid fields.',
        context: 'Use for forms where early validation can prevent frustration. Especially valuable for complex validation rules, format requirements, and fields that commonly cause errors.',
        structure: {
            description: 'Validation logic runs on blur, change, or after a debounce delay. Error messages appear near the field (typically below). Success states may show checkmarks.',
    ...
    },
    {
        ...
        solution: 'Break the form into logical steps shown one at a time. Provide progress indication, navigation between steps, and preserve data as users move.',
        context: 'Use for long forms (checkout, registration, onboarding), processes with conditional logic, or when context needs to be set before later questions make sense.',
        structure: {
            description: 'A progress indicator showing steps, content area for current step, and navigation controls (back/next/submit). Data persists as users navigate.',
    ...
    },
    {
        ...
        solution: 'Provide labeled input fields with clear visual boundaries, appropriate input types, and supporting elements like help text and error messages.',
        context: 'The fundamental building block of any form. Every input should have a label, appropriate type, and may include placeholder, help text, and validation feedback.',
        structure: {
            description: 'A label identifying the field, the input control itself, optional help text, and space for error messages. May include required indicator and character count.',
    ...
    },
    {
        ...
        solution: 'Show suggestions as the user types. Suggestions can come from a predefined list, search results, or the user\'s history.',
        context: 'Use when there are many possible values, for address/location fields, search inputs, or selecting from a database of options. Balance between too few suggestions (unhelpful) and too many (overwhelming).',
        structure: {
            description: 'An input field that shows a dropdown list of suggestions as the user types. Users can select from suggestions or continue typing.',
    ...
    },
    {
        ...
        solution: 'Apply an input mask that formats the user\'s input as they type, automatically adding separators, limiting characters, and enforcing patterns.',
        context: 'Use for fields with known formats: phone numbers, dates, credit card numbers, social security numbers, postal codes. Be flexible—accept various inputs and format them.',
        structure: {
            description: 'An input field with logic that transforms and constrains input in real-time. May show format hints as placeholder.',
    ...
    },
    {
        ...
        solution: 'Provide a switch control that clearly shows on/off state. Toggling should take effect immediately without a separate save action.',
        context: 'Use for binary settings that apply immediately. Different from checkboxes which typically require form submission. Common for preferences and feature toggles.',
        structure: {
            description: 'A track with a sliding thumb that moves between on and off positions. Often includes labels or icons showing the current state.',
    ...
    },
    {
        ...
        solution: 'Provide a calendar-style interface for selecting dates visually. May combine with text input for direct typing.',
        context: 'Use when users need to select dates, especially when context matters (day of week) or date range matters. Consider native date inputs on mobile.',
        structure: {
            description: 'A calendar grid showing days in a month, with navigation for months/years. May include time selection for datetime inputs.',
