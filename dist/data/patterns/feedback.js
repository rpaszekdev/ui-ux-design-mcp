...
export const feedbackPatterns = [
    {
        ...
        solution: 'Display a small, temporary message that appears briefly and auto-dismisses. Toasts don\'t require user action and don\'t block interaction.',
        context: 'Use for confirmations of actions (saved, sent, copied), background events (new message), or non-critical information. Not for errors requiring action.',
        structure: {
            description: 'A small container with a message, appearing at screen edge (often bottom or top-right). May include icon and dismiss action. Auto-disappears after 3-5 seconds.',
    ...
    },
    {
        ...
        solution: 'Display content in a dialog box overlaid on the page. A dimmed backdrop blocks interaction with the underlying page until the modal is closed.',
        context: 'Use for tasks requiring focus (compose message), confirmations (delete?), important alerts, or subsidiary information. Don\'t overuse—modals interrupt flow.',
        structure: {
            description: 'A focused dialog box in the viewport center with backdrop overlay. Contains header, content, and action buttons. Traps focus and closes via action or escape.',
    ...
    },
    {
        ...
        solution: 'Display an animated indicator (spinner) showing that work is in progress. Optionally include text describing what\'s loading.',
        context: 'Use when operations take more than ~1 second. For very short waits, no feedback needed. For very long waits, consider progress bars. Always show for uncertain durations.',
        structure: {
            description: 'An animated circular or linear indicator, optionally with text. May replace content (skeleton) or overlay it.',
    ...
    },
    {
        ...
        solution: 'Display placeholder shapes that match the content structure while loading. These "bones" of content show where text, images, and elements will appear.',
        context: 'Use instead of spinners when content structure is known. Particularly effective for lists, cards, and content-heavy layouts. Makes loading feel faster.',
        structure: {
            description: 'Placeholder elements matching the shape and position of expected content. Typically gray boxes with subtle animation (shimmer or pulse).',
    ...
    },
    {
        ...
        solution: 'Show a visual representation of progress, either as a percentage, steps completed, or estimated time remaining.',
        context: 'Use for operations with known duration or steps. File uploads, multi-step processes, or any measurable progress. Better than spinners for longer operations.',
        structure: {
            description: 'A bar, circle, or step indicator showing completion. May include percentage, step count, or time remaining.',
    ...
    },
    {
        ...
        solution: 'Display a helpful message explaining the empty state and provide clear actions for creating content or understanding why it\'s empty.',
        context: 'Use for empty lists, search results with no matches, blank dashboards, and first-time experiences. Every empty state is an opportunity to guide users.',
        structure: {
            description: 'An illustration or icon, explanatory text, and call-to-action button. Centered in the empty area.',
    ...
    },
    {
        ...
        solution: 'Display a clear message explaining the error in plain language and suggest specific corrective actions.',
        context: 'Use for any error condition—form validation, system errors, network issues. The message should be helpful, not technical. Position near the error source.',
        structure: {
            description: 'An error indicator (icon, color), clear message, and recovery action. For form errors, appears near the field.',
    ...
    },
    {
        ...
        solution: 'Display a prominent banner across the top of the page or section conveying important information. Persists until dismissed or condition is resolved.',
        context: 'Use for system status (maintenance), required actions (verify email), warnings, or announcements. More prominent than toasts, less blocking than modals.',
        structure: {
            description: 'A full-width banner, typically at top of page, with message, severity indication, and optional actions.',
