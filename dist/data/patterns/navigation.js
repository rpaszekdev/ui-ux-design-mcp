...
export const navigationPatterns = [
    {
        ...
        solution: 'Provide a horizontal row of labeled tabs that let users switch between content panels. One tab is always active, showing its associated content.',
        context: 'Use when you have 2-7 distinct categories of content that belong together conceptually but are too much to show simultaneously. Tabs should represent mutually exclusive views.',
        structure: {
            description: 'A tab bar container with individual tab items. Each tab has a label and may have an icon. The active tab is visually distinguished. Below is the content panel that changes based on selection.',
    ...
    },
    {
        ...
        solution: 'Provide a vertical sidebar along the left edge containing navigation links. The sidebar remains visible as users navigate, providing constant access to the navigation structure.',
        context: 'Use for applications with complex navigation needs, dashboards, or content-rich sites. Best when users frequently jump between sections. Common in admin panels, productivity tools, and enterprise software.',
        structure: {
            description: 'A fixed or sticky vertical column, usually 200-280px wide, containing navigation items. May include sections, icons, expandable groups, and a header/logo area.',
    ...
    },
    {
        ...
        solution: 'Hide navigation behind a three-line "hamburger" icon (☰). Tapping reveals a menu (usually as a sidebar overlay or dropdown) containing navigation options.',
        context: 'Common on mobile where screen space is limited. Use for secondary navigation on mobile or when you have more than 4-5 top-level navigation items. Less appropriate as primary navigation on desktop.',
        structure: {
            description: 'A hamburger icon button that toggles a navigation panel. The panel typically slides in from the left or drops down. Includes navigation items and may have user account info.',
    ...
    },
    {
        ...
        solution: 'Place a navigation bar at the bottom of the screen with 3-5 icon-and-label destinations. The current destination is highlighted.',
        context: 'Use for mobile apps with 3-5 equally important top-level destinations. This is the primary navigation pattern for both iOS (tab bar) and Android (bottom navigation). Not suitable for less than 3 or more than 5 destinations.',
        structure: {
            description: 'A fixed bar at the bottom of the screen containing 3-5 navigation items. Each item has an icon and label. The active destination is visually distinguished.',
    ...
    },
    {
        ...
        solution: 'Display a horizontal trail showing the path from the home page to the current page. Each level is a clickable link except the current page.',
        context: 'Use on sites with hierarchical structure deeper than 2 levels. E-commerce, documentation, and content sites benefit most. Less useful on flat sites or apps without page hierarchy.',
        structure: {
            description: 'A horizontal row of links separated by delimiters (>, /, or icons), showing the hierarchical path. The current page is typically non-clickable text.',
    ...
    },
    {
        ...
        solution: 'Provide a search input where users can type queries, with results displayed either inline or on a dedicated results page. Include suggestions and filters to help refine searches.',
        context: 'Use when there\'s enough content that browsing would be inefficient. Essential for content-heavy sites, e-commerce, and any application where users have specific goals.',
        structure: {
            description: 'A text input (often with search icon) that accepts queries. May include autocomplete suggestions, search history, and filters. Results may appear as you type or after submission.',
    ...
    },
    {
        ...
        solution: 'Split content into pages and provide controls to navigate between them. Show current page, total pages (or results), and navigation controls.',
        context: 'Use for search results, product listings, tables with many rows, or any content too large to display at once. Consider infinite scroll or "load more" as alternatives.',
        structure: {
            description: 'Page number indicators, previous/next buttons, and optionally first/last buttons. May include page size selector and result count.',
