...
export const layoutPatterns = [
    {
        ...
        solution: 'Group related content in a rectangular container with clear boundaries (border, shadow, or background). Each card is a self-contained unit of content.',
        context: 'Use for collections of similar items (products, articles, users), dashboard widgets, or any content that benefits from visual grouping. Cards are the building blocks of many interfaces.',
        structure: {
            description: 'A contained rectangular region with optional header, media, body content, and actions. May include metadata.',
    ...
    },
    {
        ...
        solution: 'Display items vertically (or horizontally) with consistent structure. Each item has the same layout making them easy to scan and compare.',
        context: 'Use for any collection of similar items: emails, contacts, settings, search results. Lists are more space-efficient than cards for text-heavy content.',
        structure: {
            description: 'Vertically stacked items with consistent layout. Items may include leading element (icon, avatar), content, and trailing element (action, metadata).',
    ...
    },
    {
        ...
        solution: 'Arrange items in a two-dimensional grid with consistent sizing. Grids work well for visual content like images, products, or cards.',
        context: 'Use when items have strong visual components and horizontal space should be utilized. Common for galleries, product catalogs, portfolios.',
        structure: {
            description: 'Items arranged in rows and columns. May have fixed columns or responsive column count. Gutters provide spacing.',
    ...
    },
    {
        ...
        solution: 'Create a large, impactful section at the top of the page with headline, subheadline, call-to-action, and often a striking visual.',
        context: 'Use on landing pages, homepages, and marketing pages. The hero is the first thing users see and should communicate value proposition quickly.',
        structure: {
            description: 'Full-width section, often full viewport height, with large typography, CTA button, and background image/video or illustration.',
    ...
    },
    {
        ...
        solution: 'Split the interface into two panels: a list (master) on one side and details of the selected item on the other.',
        context: 'Use for email clients, file browsers, settings panels, or any interface where users move between items frequently. Common on tablets and desktop.',
        structure: {
            description: 'Two-column layout with list panel (usually narrower) and detail panel. Selection in list updates detail view.',
    ...
    },
    {
        ...
        solution: 'Automatically load more content as the user scrolls near the bottom of the page. Creates a seamless browsing experience.',
        context: 'Use for social feeds, image galleries, search results when discovery is the goal. Consider pagination for task-oriented browsing or when users need to find specific items.',
        structure: {
            description: 'Initial content loads, then more content appends as user scrolls. May include loading indicator at bottom.',
    ...
    },
    {
        ...
        solution: 'A panel that slides up from the bottom of the screen, partially covering content. Can be dismissed by swiping down or tapping outside.',
        context: 'Use for contextual actions, sharing options, filters, or additional information on mobile. More mobile-native than modals. Common in Material Design.',
        structure: {
            description: 'A panel attached to the bottom of the screen, slides up on trigger. May have drag handle, partial or full height.',
    ...
    },
    {
        ...
        solution: 'A circular button floating above the content, typically in the bottom-right corner. Represents the primary action for the current screen.',
        context: 'Use when there\'s one primary action for the screen (compose, add, create). More common in Material Design than iOS. Limit to one FAB per screen.',
        structure: {
            description: 'A circular button with icon, positioned floating above content. May expand to reveal related actions.',
