 ...
 */
export type TokenCategory = 'color' | 'spacing' | 'typography' | 'border-radius' | 'shadow' | 'breakpoint' | 'z-index' | 'animation';
/**
 ...
 */
export type AnyDesignToken = ColorToken | SpacingToken | TypographyToken | BorderRadiusToken | ShadowToken | BreakpointToken | ZIndexToken | AnimationToken;
