...
export const typographyPrinciples: DesignPrinciple[] = [
  ...
  },
  {
    ...
    source: {
      ...
      year: 2013,
      chapter: "Typography in Ten Minutes",
    },
    importance: "critical",
  },
  {
  ...
  },
  {
    ...
    applications: ["Body text", "Headlines", "Tables", "Forms", "Captions"],
    relatedPrinciples: [
      "alignment",
  ...
  },
  {
    ...
    source: {
      ...
      year: 2014,
      chapter: "Evaluating and Applying Webfonts",
      isbn: "978-1937557065",
    },
    importance: "medium",
  },
